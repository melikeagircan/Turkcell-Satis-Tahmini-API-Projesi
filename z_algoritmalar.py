# BÜTÜN MODELLERMELERİN KARŞILAŞTIRILMASI 
import pandas as pd
import numpy as np
...
df = pd.read_csv(r'C:\Users\agirc\Downloads\Turkcell-Satis-Tahmini-API-Projesi-main (1)\Turkcell-Satis-Tahmini-API-Projesi-main\z_processed_data.csv')
...
# Modelin özellik önem skorlarını al
feature_importances = best_dt.feature_importances_

# Özellik isimleriyle birlikte sıralı bir DataFrame oluştur
importances_df = pd.DataFrame({
    'Feature': X_train.columns,  # Özellik isimlerini buradan alıyoruz
